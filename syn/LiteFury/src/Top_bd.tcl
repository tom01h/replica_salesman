...
# module references:
# led_blinker_id, vtop, dna_reader, user_efuse
...
proc create_root_design { parentCell } {
  ...
  set emc_clk [ create_bd_port -dir I -type clk -freq_hz 90000000 emc_clk ]
  ...
  # Create instance: led_blinker_id_0, and set properties
  set block_name led_blinker_id
  set block_cell_name led_blinker_id_0
  if { [catch {set led_blinker_id_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $led_blinker_id_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set block_name vtop
  set block_cell_name vtop_0
  if { [catch {set vtop_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $vtop_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins GPIO_regs/S_AXI] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins xadc_wiz_0/s_axi_lite]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M01_AXI [get_bd_intf_pins axi_interconnect_1/M01_AXI] [get_bd_intf_pins vtop_0/S_AXI]
  ...
  # Create port connections
  connect_bd_net -net GPIO_regs_gpio2_io_o [get_bd_pins GPIO_regs/gpio2_io_o] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net S00_ACLK_1 [get_bd_pins GPIO_regs/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins xadc_wiz_0/s_axi_aclk] [get_bd_pins xdma_0/axi_aclk]
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins GPIO_regs/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn] [get_bd_pins xdma_0/axi_aresetn]
  connect_bd_net -net axi_quad_spi_0_ss_o [get_bd_ports LED_A2] [get_bd_ports real_spi_ss] [get_bd_pins axi_quad_spi_0/ss_o]
  connect_bd_net -net emc_clk_1 [get_bd_ports emc_clk] [get_bd_pins led_blinker_id_0/clk]
  connect_bd_net -net led_blinker_id_0_led [get_bd_ports LED_A1] [get_bd_pins led_blinker_id_0/led]
  ...
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_100M/slowest_sync_clk] [get_bd_pins vtop_0/S_AXI_ACLK]
  connect_bd_net -net mig_7series_0_ui_clk_sync_rst [get_bd_pins mig_7series_0/ui_clk_sync_rst] [get_bd_pins rst_mig_7series_0_100M/ext_reset_in] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net pci_reset_1 [get_bd_ports pci_reset] [get_bd_pins xdma_0/sys_rst_n]
  connect_bd_net -net rst_mig_7series_0_100M_peripheral_aresetn [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins rst_mig_7series_0_100M/peripheral_aresetn] [get_bd_pins vtop_0/S_AXI_ARESETN]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_ports LED_A3] [get_bd_ports LED_A4] [get_bd_pins xlconstant_0/dout]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins led_blinker_id_0/state] [get_bd_pins xlslice_0/Dout]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI_LITE] [get_bd_addr_segs GPIO_regs/axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x00001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI_LITE] [get_bd_addr_segs GPIO_regs/axi_gpio_1/S_AXI/Reg] -force
  assign_bd_address -offset 0x00002000 -range 0x00001000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI_LITE] [get_bd_addr_segs GPIO_regs/axi_gpio_2/S_AXI/Reg] -force
  assign_bd_address -offset 0x00010000 -range 0x00001000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI_LITE] [get_bd_addr_segs axi_quad_spi_0/AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x20000000 -range 0x00100000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI] [get_bd_addr_segs vtop_0/S_AXI/reg0] -force
