...
proc create_root_design { parentCell } {
  ...
  set block_name pmodIf
  set block_cell_name pmodIf_0
  if { [catch {set pmodIf_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_intf_net -intf_net pmodIf_0_axi_periph_M00_AXI [get_bd_intf_pins pmodIf_0_axi_periph/M00_AXI] [get_bd_intf_pins vtop_0/S_AXI]
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins rst_clk_wiz_100M/ext_reset_in] [get_bd_pins util_vector_logic_0/Op1]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins clk_wiz/reset] [get_bd_pins util_vector_logic_0/Res]
