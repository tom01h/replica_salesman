...
vlog.exe -sv -dpiheader dpiheader.h ../rtl/replica_pkg.sv tb.sv \
    ...
    ../rtl/random.sv  ../rtl/or_rand.sv  ../rtl/tw_rand.sv \
    ../rtl/distance.sv ../rtl/metropolis.sv ../rtl/replica.sv ../rtl/replica_d.sv \
    ../rtl/exchange.sv ../rtl/opt_route_or.sv ../rtl/opt_route_two.sv
